		...
		content=[Br(),Container([\
					Card([\
						Form([\
							...
							# Title4(text=b"Detect motion when difference of : "),
							# Slider(text=b"hue is greater or equal than",          name=b"hueDetection",        min=b"1",  max=b"100", step=b"1",  value=b"%d"%config.hueDetection,         disabled=disabled),
							# Slider(text=b"saturation is greater or equal than",   name=b"saturationDetection", min=b"1",  max=b"100", step=b"1",  value=b"%d"%config.saturationDetection,  disabled=disabled),
							# Slider(text=b"light is greater or equal than",        name=b"lightDetection",      min=b"1",  max=b"100", step=b"1",  value=b"%d"%config.lightDetection,       disabled=disabled),
							# Tag(b'<small style="color:grey">The notification contains the detection information, "H=" hue, "S=" saturation and "L=" light</small>'),Br(),Br(),
							# Title4(text=b"Configuration motion detection"),
							Slider(text=b"Detect motion when difference is greater or equal than",          name=b"contigousDetection",        min=b"1",  max=b"100", step=b"1",  value=b"%d"%config.contigousDetection,         disabled=disabled),
