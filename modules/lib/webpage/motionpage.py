		...
		content=[Br(),Container([\
					Card([\
						Form([\
							...
							Title4(text=b"Motion detection threshold"),
							Slider(text=b"On change of saturation",   name=b"saturationDetection", min=b"1",  max=b"100", step=b"1",  value=b"%d"%config.saturationDetection,  disabled=disabled),
							Slider(text=b"On change of light",        name=b"lightDetection",      min=b"1",  max=b"100", step=b"1",  value=b"%d"%config.lightDetection,       disabled=disabled),
