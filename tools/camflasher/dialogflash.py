...
class Ui_DialogFlash(object):
    def setupUi(self, DialogFlash):
        ...
        self.firmware.setInsertPolicy(QtWidgets.QComboBox.InsertAtTop)
        self.firmware.setObjectName("firmware")
        self.horizontalLayout.addWidget(self.firmware)
        ...
        self.horizontalLayout.addWidget(self.select_firmware)
        ...
        self.gridLayout.addLayout(self.baud_layout, 3, 0, 1, 3)
