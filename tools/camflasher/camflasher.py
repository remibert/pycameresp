...
class Ui_CamFlasher(object):
    def setupUi(self, CamFlasher):
        ...
        self.action_upload_shell = QtWidgets.QAction(CamFlasher)
        self.action_upload_shell.setObjectName("action_upload_shell")
        self.action_upload_server = QtWidgets.QAction(CamFlasher)
        ...
        self.menu_tools.addAction(self.action_upload_shell)
        self.menu_tools.addAction(self.action_upload_server)
    ...
    def retranslateUi(self, CamFlasher):
        ...
        self.action_flash.setText(_translate("CamFlasher", "Flash firmware"))
