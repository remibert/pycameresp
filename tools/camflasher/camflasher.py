...
class Ui_CamFlasher(object):
    def setupUi(self, CamFlasher):
        ...
        self.gridLayout_3.addWidget(self.label_telnet_port, 0, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.edit_telnet_port, 0, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.button_telnet_connect, 0, 4, 1, 1)
        ...
        self.action_inject_shell = QtGui.QAction(CamFlasher)
        self.action_inject_shell.setObjectName("action_inject_shell")
        self.action_inject_server = QtGui.QAction(CamFlasher)
